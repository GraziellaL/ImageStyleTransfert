...
data_folder = "ImageStyleTransfert/Util_libs/ImageNet-Datasets-Downloader/imagenet_images"  # REPLACE with a valid location
output_filename = "vgg19_norm_weights.h5"
...
if __name__ == "__main__":
    vgg_net = vgg19.VGG19(include_top=False, weights='imagenet')
    #vgg_net = VGG19_avg(weights_normalization=False)
    mean_activations = []
    x = vgg_net.input
    ...
    idgen = ImageDataGenerator(preprocessing_function=vgg19.preprocess_input)
